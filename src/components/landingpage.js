...
import logo from './1582833369250.jpg';
            ...
            < div style ={{width: '100%' , margin: 'auto'}}>
                <Grid classname="landing-grid">
                    ...
                    <div className="banner-text">
                        <h1>Graduate Engineer</h1>

                    <hr/>
                    <p>Learner | Student Intern at Altair</p>
                    <div className="social-links">
                        {/*Linkedin*/}
                        <a href="https://www.linkedin.com/in/anirudh-varadarajan-85a434182/" rel="noopener noreferrer" target="blank">
                          <i className="fa fa-linkedin-square" aria-hidden="true"/>  
                        </a>
                        {/*Github*/}
                        <a href="https://github.com/ani1208" rel="noopener noreferrer" target="blank">
                          <i className="fa fa-github-square" aria-hidden="true"/>  
                        </a>

                        {/*hackerrrank*/}
                        <a href="https://www.hackerrank.com/ani1208dh" rel="noopener noreferrer" target="blank">
